...
// 主選單 : 1. 下拉的選單-只要改 text 和 go2 的連結網址--------------
	...
	({id: 'mainMenu1',
	 ...
	 items: [
	 {text: '1.雙品',
	   handler: function(){go2("Dh1.htm")}},
	 {text: '2.不放逸品',
	   handler: function(){go2("Dh2.htm")}},
	 {text: '3.心品',
	   handler: function(){go2("Dh3.htm")}},
	 {text: '4.花品',
	   handler: function(){go2("Dh4.htm")}},
	 {text: '5.愚者品',
	   handler: function(){go2("Dh5.htm")}},
	 {text: '6.賢智者品',
	   handler: function(){go2("Dh6.htm")}},
	 {text: '7.阿羅漢品',
	   handler: function(){go2("Dh7.htm")}},
	 {text: '8.千品',
	   handler: function(){go2("Dh8.htm")}},
	 {text: '9.惡品',
	   handler: function(){go2("Dh9.htm")}},
	 {text: '10.棍棒品',
	   handler: function(){go2("Dh10.htm")}}
	             ]
	});
	...
	({id: 'mainMenu2',
	 ...
	 items: [
	 {text: '11.老品',
	   handler: function(){go2("Dh11.htm")}},
	 {text: '12.自己品',
	   handler: function(){go2("Dh12.htm")}},
	 {text: '13.世間品',
	   handler: function(){go2("Dh13.htm")}},
	 {text: '14.佛陀品',
	   handler: function(){go2("Dh14.htm")}},
	 {text: '15.樂品',
	   handler: function(){go2("Dh15.htm")}},
	 {text: '16.所愛品',
	   handler: function(){go2("Dh16.htm")}},
	 {text: '17.憤怒品',
	   handler: function(){go2("Dh17.htm")}},
	 {text: '18.垢品',
	   handler: function(){go2("Dh18.htm")}},
	 {text: '19.法住品',
	   handler: function(){go2("Dh19.htm")}},
	 {text: '20.道品',
	   handler: function(){go2("Dh20.htm")}}
	             ]
	});
	...
	({id: 'mainMenu2',
	 ...
	 items: [
	 {text: '21.雜多品',
	   handler: function(){go2("Dh21.htm")}},
	 {text: '22.地獄品',
	   handler: function(){go2("Dh22.htm")}},
	 {text: '23.象品',
	   handler: function(){go2("Dh23.htm")}},
	 {text: '24.渴愛品',
	   handler: function(){go2("Dh24.htm")}},
	 {text: '25.比丘品',
	   handler: function(){go2("Dh25.htm")}},
	 {text: '26.婆羅門品',
	   handler: function(){go2("Dh26.htm")}}
	             ]
	});
...
// 主選單 : 2.橫式主選單 ------------------------------
	...
	{text:'　1-10品',  menu: menu1}, // 下拉的選單
	{text:'　 11-20品',  menu: menu2}, // 下拉的選單
	{text:'　 21-26品',  menu: menu3}, // 下拉的選單
	{text:'　上一品/',
...
// 隱藏選單
	...
	function pre_sutra() {
		...
		if (myurl.match(/Dh(\d+)\.htm/) != null){var sutranum = myurl.replace(/^.*?(\d+)\.htm/i,"$1");}// 取出經號
		var pre_sutra = parseInt(sutranum,10) - 1; 
		// 前一經
		if(pre_sutra < 1){pre_sutra = 26;}
		pre_sutra = "Dh" + pre_sutra.toString() + ".htm";
		go2(pre_sutra);
	}
	function next_sutra() {
		var myurl=window.location.toString();
		...
		// 下一經
		if(next_sutra > 26) {next_sutra = 1;}
		next_sutra = "Dh" + next_sutra.toString() + ".htm";
		go2(next_sutra);
	}
// 選單結束 ----------------------
    });
