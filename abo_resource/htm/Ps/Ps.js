...
// 主選單 : 1. 下拉的選單-只要改 text 和 go2 的連結網址--------------
	...
	({id: 'mainMenu1',
	 ...
	 items: [
	 {text: '1.智',
	   handler: function(){go2("Ps1.htm")}},
	 {text: '2.見',
	   handler: function(){go2("Ps2.htm")}},
	 {text: '3.入出息念',
	   handler: function(){go2("Ps3.htm")}},
	 {text: '4.根',
	   handler: function(){go2("Ps4.htm")}},
	 {text: '5.解脫',
	   handler: function(){go2("Ps5.htm")}},
	 {text: '6.趣',
	   handler: function(){go2("Ps6.htm")}},
	 {text: '7.業',
	   handler: function(){go2("Ps7.htm")}},
	 {text: '8.顛倒',
	   handler: function(){go2("Ps8.htm")}},
	 {text: '9.道',
	   handler: function(){go2("Ps9.htm")}},
	 {text: '10.醍醐味',
	   handler: function(){go2("Ps10.htm")}}
	             ]
	});
	...
	({id: 'mainMenu2',
	 ...
	 items: [
	 {text: '11.雙連',
	   handler: function(){go2("Ps11.htm")}},
	 {text: '12.諦',
	   handler: function(){go2("Ps12.htm")}},
	 {text: '13.覺支',
	   handler: function(){go2("Ps13.htm")}},
	 {text: '14.慈',
	   handler: function(){go2("Ps14.htm")}},
	 {text: '15.離貪',
	   handler: function(){go2("Ps15.htm")}},
	 {text: '16.無礙解',
	   handler: function(){go2("Ps16.htm")}},
	 {text: '17.法輪',
	   handler: function(){go2("Ps17.htm")}},
	 {text: '18.出世間',
	   handler: function(){go2("Ps18.htm")}},
	 {text: '19.力',
	   handler: function(){go2("Ps19.htm")}},
	 {text: '20.空',
	   handler: function(){go2("Ps20.htm")}}
	             ]
	});
	...
	({id: 'mainMenu3',
	 ...
	 items: [
	 {text: '21.大慧',
	   handler: function(){go2("Ps21.htm")}},
	 {text: '22.神通',
	   handler: function(){go2("Ps22.htm")}},
	 {text: '23.現觀',
	   handler: function(){go2("Ps23.htm")}},
	 {text: '24.遠離',
	   handler: function(){go2("Ps24.htm")}},
	 {text: '25.行為',
	   handler: function(){go2("Ps25.htm")}},
	 {text: '26.神變',
	   handler: function(){go2("Ps26.htm")}},
	 {text: '27.齊頭者',
	   handler: function(){go2("Ps27.htm")}},
	 {text: '28.念住',
	   handler: function(){go2("Ps28.htm")}},
	 {text: '29.毘婆舍那',
	   handler: function(){go2("Ps29.htm")}},
	 {text: '30.本母',
	   handler: function(){go2("Ps30.htm")}}
	             ]
	});
...
// 主選單 : 2.橫式主選單 ------------------------------
	...
	{text:'　大　品',  menu: menu1}, // 下拉的選單
	{text:'　雙 連 品',  menu: menu2}, // 下拉的選單
	{text:'　慧　品',  menu: menu3}, // 下拉的選單
	{text:'　上一談論/',
...
// 隱藏選單
	...
	function pre_sutra() {
		...
		if (myurl.match(/Ps(\d+)\.htm/) != null){var sutranum = myurl.replace(/^.*?(\d+)\.htm/i,"$1");}// 取出經號
		var pre_sutra = parseInt(sutranum,10) - 1; 
		// 前一經
		if(pre_sutra < 1){pre_sutra = 30;}
		pre_sutra = "Ps" + pre_sutra.toString() + ".htm";
		go2(pre_sutra);
	}
	function next_sutra() {
		var myurl=window.location.toString();
		...
		// 下一經
		if(next_sutra > 30) {next_sutra = 1;}
		next_sutra = "Ps" + next_sutra.toString() + ".htm";
		go2(next_sutra);
	}
// 選單結束 ----------------------
    });
