...
// 主選單 : 1. 下拉的選單-只要改 text 和 go2 的連結網址--------------
	...
	({id: 'mainMenu1',
	 ...
	 items: [
	 {text: '1.三歸依',
	   handler: function(){go2("Kh1.htm")}},
	 {text: '2.十學處',
	   handler: function(){go2("Kh2.htm")}},
	 {text: '3.三十二行相',
	   handler: function(){go2("Kh3.htm")}},
	 {text: '4.童問',
	   handler: function(){go2("Kh4.htm")}},
	 {text: '5.吉祥經',
	   handler: function(){go2("Kh5.htm")}},
	 {text: '6.寶經',
	   handler: function(){go2("Kh6.htm")}},
	 {text: '7.牆外經',
	   handler: function(){go2("Kh7.htm")}},
	 {text: '8.部分財寶經',
	   handler: function(){go2("Kh8.htm")}},
	 {text: '9.慈經',
	   handler: function(){go2("Kh9.htm")}}
	             ]
	});
...
// 隱藏選單
	...
	function pre_sutra() {
		...
		if (myurl.match(/Kh(\d+)\.htm/) != null){var sutranum = myurl.replace(/^.*?(\d+)\.htm/i,"$1");}// 取出經號
		var pre_sutra = parseInt(sutranum,10) - 1; 
		// 前一經
		if(pre_sutra < 1){pre_sutra = 9;}
		pre_sutra = "Kh" + pre_sutra.toString() + ".htm";
		go2(pre_sutra);
	}
	function next_sutra() {
		var myurl=window.location.toString();
		...
		// 下一經
		if(next_sutra >9) {next_sutra = 1;}
		next_sutra = "Kh" + next_sutra.toString() + ".htm";
		go2(next_sutra);
	}
// 選單結束 ----------------------
    });
