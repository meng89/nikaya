...
// 主選單 : 1. 下拉的選單-只要改 text 和 go2 的連結網址--------------
	...
	({id: 'mainMenu1',
	 ...
	 items: [
	 {text: '1.欲',
	   handler: function(){go2("Ni1.htm")}},
	 {text: '2.洞窟',
	   handler: function(){go2("Ni2.htm")}},
	 {text: '3.邪惡',
	   handler: function(){go2("Ni3.htm")}},
	 {text: '4.純淨',
	   handler: function(){go2("Ni4.htm")}},
	 {text: '5.最高',
	   handler: function(){go2("Ni5.htm")}},
	 {text: '6.老',
	   handler: function(){go2("Ni6.htm")}},
	 {text: '7.低舍彌勒',
	   handler: function(){go2("Ni7.htm")}},
	 {text: '8.玻素勒',
	   handler: function(){go2("Ni8.htm")}},
	 {text: '9.馬更地亞',
	   handler: function(){go2("Ni9.htm")}},
	 {text: '10.在崩解前',
	   handler: function(){go2("Ni10.htm")}},
	 {text: '11.爭吵爭辯',
	   handler: function(){go2("Ni11.htm")}},
	 {text: '12.配置小經',
	   handler: function(){go2("Ni12.htm")}},
	 {text: '13.配置大經',
	   handler: function(){go2("Ni13.htm")}},
	 {text: '14.迅速',
	   handler: function(){go2("Ni14.htm")}},
	 {text: '15.取棍棒者',
	   handler: function(){go2("Ni15.htm")}},
	 {text: '16.舍利弗',
	   handler: function(){go2("Ni16.htm")}}
	             ]
	});
	...
	({id: 'mainMenu2',
	 ...
	 items: [
	 {text: '17.序偈',
	   handler: function(){go2("Ni17.htm")}},
	 {text: '18.阿逸多',
	   handler: function(){go2("Ni18.htm")}},
	 {text: '19.低舍彌勒',
	   handler: function(){go2("Ni19.htm")}},
	 {text: '20.富樓那葛',
	   handler: function(){go2("Ni20.htm")}},
	 {text: '21.彌勒固',
	   handler: function(){go2("Ni21.htm")}},
	 {text: '22.都達葛',
	   handler: function(){go2("Ni22.htm")}},
	 {text: '23.烏玻西',
	   handler: function(){go2("Ni23.htm")}},
	 {text: '24.難陀',
	   handler: function(){go2("Ni24.htm")}},
	 {text: '25.黑瑪葛',
	   handler: function(){go2("Ni25.htm")}},
	 {text: '26.度跌亞',
	   handler: function(){go2("Ni26.htm")}},
	 {text: '27.葛波',
	   handler: function(){go2("Ni27.htm")}},
	 {text: '28.若度耿泥',
	   handler: function(){go2("Ni28.htm")}},
	 {text: '29.玻多吳達',
	   handler: function(){go2("Ni29.htm")}},
	 {text: '30.優陀亞',
	   handler: function(){go2("Ni30.htm")}},
	 {text: '31.迫沙拉',
	   handler: function(){go2("Ni31.htm")}},
	 {text: '32.莫額臘闍',
	   handler: function(){go2("Ni32.htm")}},
	 {text: '33.賓其亞',
	   handler: function(){go2("Ni33.htm")}},
	 {text: '34.稱讚',
	   handler: function(){go2("Ni34.htm")}},
	 {text: '35.隨誦',
	   handler: function(){go2("Ni35.htm")}},
	 {text: '36.犀牛角-1',
	   handler: function(){go2("Ni36.htm")}},
	 {text: '37.犀牛角-2',
	   handler: function(){go2("Ni37.htm")}},
	 {text: '38.犀牛角-3',
	   handler: function(){go2("Ni38.htm")}},
	 {text: '39.犀牛角-4',
	   handler: function(){go2("Ni39.htm")}}
	             ]
	});
...
// 主選單 : 2.橫式主選單 ------------------------------
	...
	{text:'　大 義 釋',  menu: menu1}, // 下拉的選單
	{text:'　 小 義 釋',  menu: menu2}, // 下拉的選單
	{text:'　上一經/',
...
// 隱藏選單
	...
	function pre_sutra() {
		...
		if (myurl.match(/Ni(\d+)\.htm/) != null){var sutranum = myurl.replace(/^.*?(\d+)\.htm/i,"$1");}// 取出經號
		var pre_sutra = parseInt(sutranum,10) - 1; 
		// 前一經
		if(pre_sutra < 1){pre_sutra = 39;}
		pre_sutra = "Ni" + pre_sutra.toString() + ".htm";
		go2(pre_sutra);
	}
	function next_sutra() {
		var myurl=window.location.toString();
		...
		// 下一經
		if(next_sutra > 39) {next_sutra = 1;}
		next_sutra = "Ni" + next_sutra.toString() + ".htm";
		go2(next_sutra);
	}
// 選單結束 ----------------------
    });
