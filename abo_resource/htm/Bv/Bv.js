...
// 主選單 : 1. 下拉的選單-只要改 text 和 go2 的連結網址--------------
	...
	({id: 'mainMenu1',
	 ...
	 items: [
	 {text: '1.寶物經行處章',
	   handler: function(){go2("Bv1.htm")}},
	 {text: '2.蘇昧達的願求說',
	   handler: function(){go2("Bv2.htm")}},
	 {text: '3.燃燈佛種姓',
	   handler: function(){go2("Bv3.htm")}},
	 {text: '4.憍陳如…',
	   handler: function(){go2("Bv4.htm")}},
	 {text: '5.吉祥…',
	   handler: function(){go2("Bv5.htm")}}
	             ]
	});
	...
	({id: 'mainMenu2',
	 ...
	 items: [
	 {text: '6.善意佛種姓',
	   handler: function(){go2("Bv6.htm")}},
	 {text: '7.雷瓦達…',
	   handler: function(){go2("Bv7.htm")}},
	 {text: '8.輝耀…',
	   handler: function(){go2("Bv8.htm")}},
	 {text: '9.阿諾瑪達辛…',
	   handler: function(){go2("Bv9.htm")}},
	 {text: '10.帕度麼…',
	   handler: function(){go2("Bv10.htm")}}
	             ]
	});
	...
	({id: 'mainMenu3',
	 ...
	 items: [
	 {text: '11.那樂得佛種姓',
	   handler: function(){go2("Bv11.htm")}},
	 {text: '12.帕度鬱多羅…',
	   handler: function(){go2("Bv12.htm")}},
	 {text: '13.蘇昧達…',
	   handler: function(){go2("Bv13.htm")}},
	 {text: '14.善生…',
	   handler: function(){go2("Bv14.htm")}},
	 {text: '15.皮亞達西…',
	   handler: function(){go2("Bv15.htm")}}
	             ]
	});
	...
	({id: 'mainMenu4',
	 ...
	 items: [
	 {text: '16.阿大達西佛種姓',
	   handler: function(){go2("Bv16.htm")}},
	 {text: '17.達摩達西…',
	   handler: function(){go2("Bv17.htm")}},
	 {text: '18.悉達多…',
	   handler: function(){go2("Bv18.htm")}},
	 {text: '19.低舍…',
	   handler: function(){go2("Bv19.htm")}},
	 {text: '20.弗沙…',
	   handler: function(){go2("Bv20.htm")}}
	             ]
	});
	...
	({id: 'mainMenu5',
	 ...
	 items: [
	 {text: '21.毘婆尸佛種姓',
	   handler: function(){go2("Bv21.htm")}},
	 {text: '22.尸棄…',
	   handler: function(){go2("Bv22.htm")}},
	 {text: '23.毘舍浮…',
	   handler: function(){go2("Bv23.htm")}},
	 {text: '24.拘留孫…',
	   handler: function(){go2("Bv24.htm")}},
	 {text: '25.拘那含…',
	   handler: function(){go2("Bv25.htm")}}
	             ]
	});
	...
	({id: 'mainMenu6',
	 ...
	 items: [
	 {text: '26.迦葉佛種姓',
	   handler: function(){go2("Bv26.htm")}},
	 {text: '27.喬達摩…',
	   handler: function(){go2("Bv27.htm")}},
	 {text: '28.種種佛章',
	   handler: function(){go2("Bv28.htm")}},
	 {text: '29.遺骨的分配說',
	   handler: function(){go2("Bv29.htm")}}
	             ]
	});
...
// 主選單 : 2.橫式主選單 ------------------------------
	...
	{text:'　1-5',  menu: menu1}, // 下拉的選單
	{text:' 6-10',  menu: menu2}, // 下拉的選單
	{text:' 11-15',  menu: menu3}, // 下拉的選單
	{text:' 16-20',  menu: menu4}, // 下拉的選單
	{text:' 21-25',  menu: menu5}, // 下拉的選單
	{text:' 25-29',  menu: menu6}, // 下拉的選單
	{text:'　上則 /',
...
// 隱藏選單
	...
	function pre_sutra() {
		...
		if (myurl.match(/Bv(\d+)\.htm/) != null){var sutranum = myurl.replace(/^.*?(\d+)\.htm/i,"$1");}// 取出經號
		var pre_sutra = parseInt(sutranum,10) - 1; 
		// 前一經
		if(pre_sutra < 1){pre_sutra = 29;}
		pre_sutra = "Bv" + pre_sutra.toString() + ".htm";
		go2(pre_sutra);
	}
	function next_sutra() {
		var myurl=window.location.toString();
		...
		// 下一經
		if(next_sutra > 29) {next_sutra = 1;}
		next_sutra = "Bv" + next_sutra.toString() + ".htm";
		go2(next_sutra);
	}
// 選單結束 ----------------------
    });
