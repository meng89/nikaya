...
// 主選單 : 1. 下拉的選單-只要改 text 和 go2 的連結網址--------------
	...
	({id: 'mainMenu1',
	 ...
	 items: [
	 {text: '1.沙竭城',
	   handler: function(){go2("Mi1.htm")}},
	 {text: '2.過去業',
	   handler: function(){go2("Mi2.htm")}},
	 {text: '3.彌蘭王',
	   handler: function(){go2("Mi3.htm")}},
	 {text: '4.摩訶先那',
	   handler: function(){go2("Mi4.htm")}},
	 {text: '5.尊者那先',
	   handler: function(){go2("Mi5.htm")}},
	 {text: '6.證須陀洹',
	   handler: function(){go2("Mi6.htm")}},
	 {text: '7.證阿羅漢',
	   handler: function(){go2("Mi7.htm")}},
	 {text: '8.到沙竭城',
	   handler: function(){go2("Mi8.htm")}},
	 {text: '9.彌蘭往見',
	   handler: function(){go2("Mi9.htm")}}
	             ]
	});
	...
	({id: 'mainMenu2',
	 ...
	 items: [
	 {text: '10.大品',
	   handler: function(){go2("Mi10.htm")}},
	 {text: '11.時間品',
	   handler: function(){go2("Mi11.htm")}},
	 {text: '12.伺品',
	   handler: function(){go2("Mi12.htm")}},
	 {text: '13.涅槃品',
	   handler: function(){go2("Mi13.htm")}},
	 {text: '14.佛陀品',
	   handler: function(){go2("Mi14.htm")}},
	 {text: '15.念品',
	   handler: function(){go2("Mi15.htm")}},
	 {text: '16.無色…品',
	   handler: function(){go2("Mi16.htm")}},
	 {text: '17.問答反思',
	   handler: function(){go2("Mi17.htm")}}
	             ]
	});
	...
	({id: 'mainMenu3',
	 ...
	 items: [
	 {text: '18.前言',
	   handler: function(){go2("Mi18.htm")}},
	 {text: '19.神通力品',
	   handler: function(){go2("Mi19.htm")}},
	 {text: '20.不該壞品',
	   handler: function(){go2("Mi20.htm")}},
	 {text: '21.被遣離品',
	   handler: function(){go2("Mi21.htm")}},
	 {text: '22.一切知品',
	   handler: function(){go2("Mi22.htm")}},
	 {text: '23.深交品',
	   handler: function(){go2("Mi23.htm")}}
	             ]
	});
	...
	({id: 'mainMenu4',
	 ...
	 items: [
	 {text: '24.佛陀品',
	   handler: function(){go2("Mi24.htm")}},
	 {text: '25.無虛妄品',
	   handler: function(){go2("Mi25.htm")}},
	 {text: '26.委散…品',
	   handler: function(){go2("Mi26.htm")}},
	 {text: '27.推論品',
	   handler: function(){go2("Mi27.htm")}}
	             ]
	});
	...
	({id: 'mainMenu5',
	 ...
	 items: [
	 {text: '28.本母',
	   handler: function(){go2("Mi28.htm")}},
	 {text: '29.驢子品',
	   handler: function(){go2("Mi29.htm")}},
	 {text: '30.海洋品',
	   handler: function(){go2("Mi30.htm")}},
	 {text: '31.地　品',
	   handler: function(){go2("Mi31.htm")}},
	 {text: '32.白蟻品',
	   handler: function(){go2("Mi32.htm")}},
	 {text: '33.獅子品',
	   handler: function(){go2("Mi33.htm")}},
	 {text: '34.猴子品',
	   handler: function(){go2("Mi34.htm")}},
	 {text: '35.水瓶品',
	   handler: function(){go2("Mi35.htm")}},
	 {text: '36.結論',
	   handler: function(){go2("Mi36.htm")}}
	             ]
	});
...
// 主選單 : 2.橫式主選單 ------------------------------
	...
	{text:'　外談論',  menu: menu1}, // 下拉的選單
	{text:'　彌蘭之問',  menu: menu2}, // 下拉的選單
	{text:'　難題之問',  menu: menu3}, // 下拉的選單
	{text:'　推論之問',  menu: menu4}, // 下拉的選單
	{text:'　比喻之問',  menu: menu5} // 下拉的選單
	);
	tb.doLayout();
...
// 隱藏選單
	...
	function pre_sutra() {
		...
		if (myurl.match(/Mi(\d+)\.htm/) != null){var sutranum = myurl.replace(/^.*?(\d+)\.htm/i,"$1");}// 取出經號
		var pre_sutra = parseInt(sutranum,10) - 1; 
		// 前一經
		if(pre_sutra < 1){pre_sutra = 36;}
		pre_sutra = "Mi" + pre_sutra.toString() + ".htm";
		go2(pre_sutra);
	}
	function next_sutra() {
		var myurl=window.location.toString();
		...
		// 下一經
		if(next_sutra > 36) {next_sutra = 1;}
		next_sutra = "Mi" + next_sutra.toString() + ".htm";
		go2(next_sutra);
	}
// 選單結束 ----------------------
    });
