...
\define[4]\sutta{\subsection[reference=SN.\somenamedheadnumber{chapter}{current}.#1,
     title={\goto{\somenamedheadnumber{chapter}{current}.{\startlua if #1==#2 then context("#1") else context("#1-#2") end \stoplua}. #3}[url(#4)]}]}
...
\startmakeup[homage]
\bookmark[tobias]{\doifmodeelse{sc}{礼敬世尊}{禮敬世尊}}
\vfill
\blank[-25*big]
$homage
\vfill
