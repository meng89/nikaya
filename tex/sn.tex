...
\define[1]\suttaref{\setupinteraction[color=RAL6037] \goto{#1}[#1]}

%\define[2]\cccref{\goto{#2}[url(#1)]}
\define[2]\ccchref{\setupinteraction[color=RAL1007] \useURL[#2][#1][][#2] \from[#2]}

\define[2]\twnr{\setupinteraction[color=RAL5019] \goto{#1}[#2]}
