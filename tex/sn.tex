...
\setupfooter
  [text]
  [after={\startframed[frame=off,bottomframe=on,framecolor=black,] \stopframed},
  ]
\setupheadertexts[]
\setupheadertexts[{\tf\bf\ss \somenamedheadnumber{chapter}{current}. \getmarking[chapter]}][]
\setupfootertexts[]
\setupfootertexts[{\ss \goto{請到莊春江工作站閱覽最新訂正版}[url(https://agama.buddhason.org/)]}][{\tfa \it \pagenumber}]
