...
%\setupfootnotenumbering[eachpage] not work
%\setupfootnotes[way=bypage] not work
...
\setuphead[subsubsubsubsubsubject][incrementnumber=list, style=\tfa\bf\ss, alternative=middle]
\setuphead[subsubsubsubsubsubsubject][incrementnumber=list, style=\tfa\bf\ss, alternative=middle]

%\setuphead[part]      [number=no,alternative=middle,,placehead=yes,header=empty,footer=empty]
\setuphead[title][before=0,after=0,space=0]
